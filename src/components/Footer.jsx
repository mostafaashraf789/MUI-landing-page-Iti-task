...
function Footer() {
  return (
    <footer className="w-full bg-black ">
      <hr className=" border-[#1f1f1f] border-4" />
      <Box className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Box className="grid grid-cols-2 lg:grid-cols-4 lg:gap-8 gap-12 pt-14 pb-20 max-w-md mx-auto md:max-w-xl lg:max-w-full">
          <Box className="block">
            <h4 className="text-xl text-white font-bold mb-7">Codementor</h4>
        ...
        <Box className="py-7 border-t border-gray-700 ">
          <Box className="flex items-center justify-center flex-col lg:space-y-0 space-y-8 lg:justify-between lg:flex-row">
            ...
            <span className="text-gray-400  block">
              ©<a href="https://pagedone.io/">Codementor</a> 2024, All rights
              reserved.
            </span>
            <Box className="flex mt-4 space-x-4 sm:justify-center sm:mt-0 ">
              <a
                href="javascript:;"
